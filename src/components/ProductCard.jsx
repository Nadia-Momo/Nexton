...
return (
<>
<div className='w-[309px] h-[448px] mt-[40px] relative group overflow-hidden'>
...
<h2 className='text-base font-poppins font-semibold text-[#111827] text-[16px]'>{producttitle}</h2>
<h2 className='text-base font-poppins font-semibold text-[#111827] text-[16px]'>${pPrice}</h2>
</div>
<div className='flex items-center justify-between mb-[15px]'>
<h2 className='text-[14px] font-poppins font-normal text-[#4B5563] '>{pCat}</h2>
 <h2 className='text-[14px] font-poppins font-normal text-[#4B5563]'>{pDis}</h2>
</div>
<div className='flex items-center gap-[4px]'>
<IoIosStar className='text-[#FBBF24] text-xl'/>
<p className='text-[14px] font-poppins font-normal text-[#4B5563]'>{pRating}({stock})</p>
</div>
</div>
</>
  )
