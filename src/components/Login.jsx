...
const Login = () => {
  return (
    <>
      <section className='Login'>
        <div className="container px-[548px] mt-[40px] mb-[72px]">
         ...
         <h2 className='font-poppins font-semibold text-[36px] text-center mb-[60px]'>Login</h2>
    <form action="" >
        <div>
            <label className='text-[#111827] font-poppins font-semibold text-[16px] mb-[8px]'>Name</label>
             <input type="text" className='border border-[#E5E7EB] bg-[#FFFFFF] rounded-[12px] w-[440px] h-[43px] mb-[24px]'/>
        </div>
           <div>
    ...
    <p className='text-[#4B5563] font-poppins font-normal text-[16px] text-center'>New User? <span className='text-[#0EA5E9]'>
